...
pub trait Status {
    async fn get_fpga_state(&self, device_handle: &str) -> Result<String>;
    async fn get_fpga_flags(&self, device_handle: &str) -> Result<String>;
    async fn get_overlay_status(&self, platform_str: &str, overlay_handle: &str) -> Result<String>;
