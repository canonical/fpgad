...
//! XilinxSys device tree overlay handler implementation.
//!
//! This module provides the [`XilinxSysOverlayHandler`] struct, which implements the
...
/// XilinxSys device tree overlay handler using Linux configfs.
///
...
#[derive(Debug)]
pub struct XilinxSysOverlayHandler {
...
/// Implementation of helper methods for XilinxSysOverlayHandler.
impl XilinxSysOverlayHandler {
...
/// Implementation of the OverlayHandler trait for XilinxSysOverlayHandler.
impl OverlayHandler for XilinxSysOverlayHandler {
    ...
    /// # Arguments
    ///
    /// * `handle` - Optional handle/slot identifier (unused in xilinx_sys implementation)
    ///
    /// # Returns: `Result<String, FpgadError>`
...
impl XilinxSysOverlayHandler {
    /// Create a new XilinxSysOverlayHandler for the specified overlay.
    ///
    ...
    ///
    /// # Returns: `Self`
    /// * New XilinxSysOverlayHandler instance
    ///
    /// # Examples
    ///
    /// ```rust,ignore
