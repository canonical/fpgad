...
#[tokio::test]
#[rstest]
#[case::reset_key("/sys/class/fpga_manager/fpga0/key", "", Ok(String::new()))]
#[case::out_of_tree("/lib/firmware/new_file", "", Err(Error::Failure("does not begin with".into())))]
#[case::missing_file("/sys/class/fpga_manager/fpga0/write_not_exist.txt", "", Err(Error::Failure("FpgadError::IOWrite: ".into())))]
pub async fn cases(
