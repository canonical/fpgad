...
#[tokio::test]
#[rstest]
#[case::all_good("universal", "fpga0", Ok("operating".to_string()))]
#[case::no_platform("", "fpga0", Ok("operating".to_string()))]
...
#[case::bad_device("universal", "dev0", Err(Error::Failure("FpgadError::Argument:".into())))]
async fn cases(
