...
#[tokio::test]
#[rstest]
#[case::load_from_lib_firmware("xlnx-sys", "fpga0", "/lib/firmware/k26-starter-kits.bit.bin", "")]
...
async fn bad_flags(
    ...
    control_proxy
        .xlnx_sys("write_flags", device_handle, "0x7F")
        .await
        .expect("failed to set fpga flags");
    expect_that!(
        status_proxy
            ...
            .expect("failed to get fpga flags"),
        eq("127"),
        "flags not 127 (0x7F) after setting to 0x7F"
    );
